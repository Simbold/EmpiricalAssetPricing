...
OLS_two_pass_estimates <- function(r, f, constant=FALSE){
...
GMM_two_pass_estimates <- function(r, f, constant=FALSE, adjust=FALSE){
  ...
  pre_estim <- OLS_two_pass_estimates(r, f, constant) 
  ...
  # computing the covariance matrix of the moment condition matrix, here using the Newey-West Bartlett HAC estimator
...
GMM_results <- GMM_two_pass_estimates(r, f, constant, adjust)
...
OLS_results <- OLS_two_pass_estimates(r, f, constant) 
